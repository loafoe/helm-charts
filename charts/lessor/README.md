...
| image.repository | string | `"ghcr.io/loafoe/lessor"` |  |
| image.tag | string | `""` |  |
| imagePullSecrets | list | `[]` |  |
| ingress.annotations | object | `{}` |  |
| ingress.className | string | `""` |  |
| ingress.enabled | bool | `false` |  |
| ingress.hosts[0].host | string | `"lessor.local"` |  |
| ingress.hosts[0].paths[0].path | string | `"/"` |  |
| ingress.hosts[0].paths[0].pathType | string | `"ImplementationSpecific"` |  |
| ingress.tls | list | `[]` |  |
| issuer | string | `"https://dex.hsp.hostedzonehere.com"` |  |
| loki.url | string | `"loki-gateway.observability.svc"` |  |
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
