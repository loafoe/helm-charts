...
Caddy plugin to manage (path based) access to services
...
| image.repository | string | `"ghcr.io/loafoe/solgate"` |  |
| image.tag | string | `""` |  |
| imagePullSecrets | list | `[]` |  |
| ingress.annotations | object | `{}` |  |
| ingress.className | string | `""` |  |
| ingress.enabled | bool | `false` |  |
| ingress.hosts[0].host | string | `"solgate.local"` |  |
| ingress.hosts[0].paths[0].path | string | `"/"` |  |
| ingress.hosts[0].paths[0].pathType | string | `"ImplementationSpecific"` |  |
| ingress.tls | list | `[]` |  |
| loki.url | string | `"loki-gateway.loki-system.svc"` |  |
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
...
| tempo.url | string | `"tempo-gateway.tempo-system.svc"` |  |
| tolerations | list | `[]` |  |
